...
public class LooseChange extends CustomCard {
	
	public static final String ID = "Loose Change";
	...
	public static final String PATH = "cards/loose_change.png";
